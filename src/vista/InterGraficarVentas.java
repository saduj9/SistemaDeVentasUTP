...
public class InterGraficarVentas extends javax.swing.JInternalFrame {
    ...
    private int MetodoContador() {
        try {
            ...
            PreparedStatement pst = cn.prepareStatement(
                    "select fecha_venta, count(fecha_venta) as Ventas from tb_cabecera_venta "
                    + "where fecha_venta BETWEEN '" + InterGraficas.fecha_inicio + "' and '" + InterGraficas.fecha_fin + "' group by fecha_venta;");
    ...
    private void MetodoAlmacenaDatos() {
        try {
            ...
            int contador = 0;
            while (rs.next()) {
                vector_fechaVenta[contador] = rs.getString("fecha_venta");
